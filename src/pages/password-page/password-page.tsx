  ...
  return (
    <form onSubmit={onClick}>
      ...
      <div className='h-dvh flex flex-col'>
        <div
          className={`w-full h-[calc(50%+24px)] pt-0 items-end justify-items-start grid grid-cols-1 tablet:grid-cols-2 ${isMobile ? 'p-s-mobile' : 'p-s-not-mobile'}`}
        >
          <Controller
            name='password'
        ...
        <div
          className='w-full h-[calc(50%-24px)]'
